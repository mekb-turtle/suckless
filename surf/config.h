...
static Parameter defconfig[ParameterLast] = {
	...
	[SmoothScrolling]     =       { { .i = 1 },     },
	[SpellChecking]       =       { { .i = 1 },     },
	[SpellLanguages]      =       { { .v = ((char *[]){ "en_AU", "en_US", NULL }) }, },
	[StrictTLS]           =       { { .i = 1 },     },
	[Style]               =       { { .i = 1 },     },
	[WebGL]               =       { { .i = 0 },     },
	[ZoomLevel]           =       { { .f = 1.0 },   },
...
static Key keys[] = {
	...
	{ MODKEY2,               GDK_KEY_Right,  navigate,   { .i = +1 } },
	{ MODKEY2,               GDK_KEY_Left,   navigate,   { .i = -1 } },

	/* vertical and horizontal scrolling, in viewport percentage */
	{ MODKEY,                GDK_KEY_Down,   scrollv,    { .i = +10 } },
	{ MODKEY,                GDK_KEY_Up,     scrollv,    { .i = -10 } },
...
//	{ MODKEY|GDK_SHIFT_MASK, GDK_KEY_g,      toggle,     { .i = Geolocation } },
	{ MODKEY|GDK_SHIFT_MASK, GDK_KEY_j,      toggle,     { .i = JavaScript } },
